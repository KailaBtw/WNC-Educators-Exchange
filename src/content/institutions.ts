...
export const institutions: Institution[] = [
  ...
  },
  {
    ...
    shortName: "App State",
    kind: "university",
    stance: "Venture-ready AI practice",
    lead: "Mountain campus partner in the Exchange—faculty experiments in AI-enabled venture creation and management education feed the regional conversation.",
    focus: [
      "AI prototyping in management courses",
      "Ethical friction built into student workflows",
      "Regional summit & award participation",
    ],
    tools: ["ChatGPT", "Claude", "Campus LMS tools"],
    more: "Appalachian State participates in the regional Exchange conversation. Expand this card from Leigha’s campus survey notes when available; Jason Kelley’s 2026 AI Innovator award (Next Carolina Ventures) is one visible App State contribution.",
  },
  {
    id: "southwestern",
