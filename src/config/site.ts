...
export const assets = {
  ...
  teamLeigha: "/images/team/leigha-travis.jpg",
  teamEllie: "/images/team/ellie.jpg",
  teamChrisCain: "/images/team/chris-cain.jpg",
  teamBill: "/images/team/bill.jpg",
  teamNana: "/images/team/nana-harrison.jpg",
  teamMegan: "/images/team/megan-coyle.jpg",
  logoBrainHub: "/files/logos/brain_hub.png",
  logoLandOfSky: "/files/logos/land_of_sky.png",
} as const;
